...
Our results for these t-tests determine if there is a statistically significant difference between union wages and non union wages in the 1980s and the 2010s.
...
tab <- rbind(
  model_parameters(t_out_1980s),
  model_parameters(t_out_2010s)
)
