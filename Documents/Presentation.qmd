...
::: {.column width="40%"}
![Plot 1](./Graph_Images/Income_by_year_adj.png)
![Plot 2](./Graph_Images/Eff_wage_by_state.png)
:::
:::
...
::: {.column width="40%"}
![Plot 6](./Graph_Images/CB_by_decade1.png){width=80%}
![Plot 7](./Graph_Images/CB_by_decade2.png){width=80%}
...
From our data analysis it can be infered that collective bargaining agreements have become a very political concept. The charts in our exploratory data analysis and regression models show this. The relationship between unions and wages/income in the United States is much harder to draw inferences. While our t-tests and some charts show that unions can help workers earn more, other graphs show that unions have a negative effect on incomes.

## Where we would take our project in the future {.smaller}
- Wage data at the state level
- Data past 2019
