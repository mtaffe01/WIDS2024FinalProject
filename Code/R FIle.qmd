...
full_state_data_1980s <- full_state_data |>
  filter(year >= 1984 & year < 1990)
CB_party_1980s_regression <- summary(lm(full_state_data_1980s$party_state_average~full_state_data_1980s$percent_collective_bargain))$coefficients
...
```{r}
CB_party_1980s_regression <- CB_party_1980s_regression |> 
  as_tibble() |> 
  mutate(Reggression_Run = c("Intercept", "percent_collective_bargain"))

CB_party_1980s_regression
```
